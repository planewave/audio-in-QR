...
// Check if SharedArrayBuffer is available before proceeding
if (typeof SharedArrayBuffer === 'undefined') {
    console.error('SharedArrayBuffer is not available. This application requires cross-origin isolation.');
    recordBtn.disabled = true;
    alert('This application requires cross-origin isolation to function. Please ensure COOP/COEP headers are properly set.');
} else {
